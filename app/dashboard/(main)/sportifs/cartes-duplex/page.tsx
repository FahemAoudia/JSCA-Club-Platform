          ...
          <div className={cn(L.sidebar, t.sidebar)}>
            ...
            <div className={cn(L.photoSlot, t.photoFrame)}>
              {p.photoUrl ? (
                ...
                <div className={cn(L.photoImg, "flex items-center justify-center text-neutral-600")}>Photo</div>
              )}
            </div>
          ...
          <div className="flex min-w-0 flex-1 flex-col justify-between min-h-0">
            <div className="flex items-start gap-1.5">
              <div className="min-w-0 flex-1 space-y-0.5">
                <p className={cn(L.kicker, "font-semibold uppercase text-neutral-600")}>LICENCE CLUB JSCA</p>
                <p className={cn(L.name, "truncate text-neutral-950")}>
                  {p.lastName.toUpperCase()} {p.firstName}
                </p>
                <p className={cn(L.meta, "text-neutral-600")}>
                  Licence <span className="font-semibold text-neutral-900">{p.licenseNumber?.trim() || "—"}</span>
                </p>
              </div>
              <Image
